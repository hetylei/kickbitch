...
<body>
    [#include '/top.ftl']
            ...
            <form action="/manage/queuelist" method="post" class="well">
                ...
                [@showPager pager=obj.pager url='/manage/queuelist'/]
                <table width="50%" 
                       class="table table-striped table-bordered table-condensed">
                    <thead>
                    <tr>
                        <th width="75" nowrap bgcolor="#999999">操作</th>
                        <th width="150" bgcolor="#999999" style="width:30%">短信内容</th>
                        ...
                        <th width="75" nowrap bgcolor="#999999">发送数量</th>
                        <th width="120" nowrap bgcolor="#999999">当前状态</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a href="/manage/queue/del/${c.id}" onClick="return confirm('确定取消发送?')">取消发送</a> <a href="javascript:showDetail('${c.id}')">详细</a></td>
                            <td>${c.msg!""}&nbsp; </td>
