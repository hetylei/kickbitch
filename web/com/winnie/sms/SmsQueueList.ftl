    ...
    [#include '/top.ftl']
            <form action="/sms/queue" method="post" class="well">
              ...
              <table border="0" cellspacing="3" cellpadding="5">
                ...
                [@showPager pager=obj.pager url='/sms/queue'/]
          <table width="50%" 
                    ...
                    <tr>
                        ...
                        <th width="120" bgcolor="#999999">当前状态</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>[#--<a href="/sms/queue/del/${c.id}" onClick="return confirm('确定取消发送?')">取消发送</a>--] <a href="javascript:showDetail('${c.id}')">详细</a></td>
                            <td>${c.msg!""}&nbsp; </td>
